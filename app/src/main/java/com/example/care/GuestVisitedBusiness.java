...
public class GuestVisitedBusiness extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btnAccountHome:
                Intent intent = new Intent(GuestVisitedBusiness.this, GuestHome.class);
